    ...
    public partial class PetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pet] SET [Name] = @Name, [TypeId] = @TypeId WHERE (([Id] = @Origina" +
                "l_Id) AND ([Name] = @Original_Name) AND ((@IsNull_TypeId = 1 AND [TypeId] IS NUL" +
                "L) OR ([TypeId] = @Original_TypeId)));\r\nSELECT Id, Name, TypeId FROM Pet WHERE (" +
                "Id = @Id)";
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> TypeId) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> TypeId, int Original_Id, string Original_Name, global::System.Nullable<int> Original_TypeId, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
